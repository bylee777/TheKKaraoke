...
import { smallBarList } from '../constants';
import { MenuCard, TypingText } from '../components';

const BarSmallRoom = () => {
  const [active, setActive] = useState(smallBarList[1]?.id || null); // Set second image active by default
  ...
  useEffect(() => {
    const initialId = smallBarList[1]?.id;
