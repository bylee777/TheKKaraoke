  ...
  <section className="w-full h-screen overflow-hidden relative">
    ...
    >
      ...
      >
        ...
        <Link
          href="/christie"
          className="absolute bottom-6 sm:bottom-12 left-1/2 -translate-x-1/2 bg-black text-white py-2 px-5 sm:py-3 sm:px-6 rounded-full text-sm sm:text-lg hover:opacity-80 transition z-10"
        >
          ← 699 Bloor St. West
        </Link>
      </motion.div>
    ...
    {/* Footer (optional, inside the same viewport) */}
