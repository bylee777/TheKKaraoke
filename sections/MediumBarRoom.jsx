...
import { medBarList } from '../constants';
import { MenuCard, TypingText } from '../components';

const MediumBarRoom = () => {
  const [active, setActive] = useState(medBarList[1]?.id || null); // Set second image active by default
  ...
  useEffect(() => {
    const initialId = medBarList[1]?.id;
