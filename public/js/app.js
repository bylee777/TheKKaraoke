...
class BarZunkoApp {
        ...
        this.rooms = [
            {
                ...
                maxCapacity: 6,
                hourlyRate: 30,
                features: ["Premium sound system", "LED lighting", "Song library 50k+", "Comfortable seating"]
            },
            {
                id: "medium", 
                name: "Medium Room",
                ...
                maxCapacity: 12,
                hourlyRate: 60,
                features: ["Enhanced sound system", "Dynamic lighting", "Song library 50k+", "Party seating", "Mini fridge"]
            },
            {
                id: "large",
                name: "Large Room", 
                ...
                maxCapacity: 20,
                hourlyRate: 90,
                features: ["Professional sound system", "Stage lighting", "Song library 50k+", "VIP seating", "Full bar service"]
            },
            {
                id: "extra-large",
                ...
                maxCapacity: 30,
                hourlyRate: 90,
                features: ["Concert-grade sound", "Stage with spotlights", "Song library 50k+", "Premium lounge", "Full bar service", "Dance floor"]
            }
        ];
    ...
    showBookingStep(step) {
        ...
        if (nextBtn) nextBtn.style.display = step === this.maxStep ? 'none' : 'flex';
        if (completeBtn) completeBtn.style.display = step === this.maxStep ? 'flex' : 'none';
            ...
            case 3:
                ...
                if (this.selectedRoom) {
                    ...
                    if (partySize < room.minCapacity || partySize > room.maxCapacity) {
                        this.showNotification(`Party size must be between ${room.minCapacity}-${room.maxCapacity} for ${room.name}`, 'error');
                        return false;
                    }
                }
    ...
    renderRoomSelection() {
        ...
        this.rooms.forEach(room => {
            ...
            roomOption.innerHTML = `
                ...
                <ul class="room-features">
                    ${room.features.slice(0, 3).map(feature => `<li>${feature}</li>`).join('')}
                </ul>
            `;
    ...
    setupPaymentFormFormatting() {
        // Set up payment form formatting after DOM is ready
        setTimeout(() => {
    ...
    lookupBooking(e) {
        ...
        setTimeout(() => {
            ...
            const booking = this.mockBookings.find(b => 
            ...
            if (booking) {
                ...
                this.showNotification('Booking not found. Please check your reference number or email.', 'error');
            }
        }, 1500);
    }
    ...
    cancelBooking(bookingId) {
        ...
        const confirmCancel = confirm(`Are you sure you want to cancel booking ${bookingId}? Your deposit of $${booking.depositPaid} will be refunded within 3-5 business days.`);
        ...
        if (confirmCancel) {
            ...
            setTimeout(() => {
                ...
                this.showNotification('Booking cancelled successfully. Refund will be processed within 3-5 business days.', 'success');
            }, 2000);
        }
    }
